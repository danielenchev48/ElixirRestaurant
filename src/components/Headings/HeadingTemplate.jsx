...
const MyDynamicTag = (props) => {
  ...
  if (headings.type === 'img') {
    ...
    if (headings.margin === '') {
      ...
      return (
        <div className={`${styles[headings.className]} ${styles[headings.margin]}`}>
          <DynamicTag src={headings.content} alt={headings.alt} />
        </div>
      );
    }
    ...
    if (headings.margin === '') {
      return (
        <div className={`${styles[headings.className]}`}>
          <ImgContainer>
            <ImagTag src={headings.imageBeforeSRC} alt={headings.imageBeforeSRC} />
            <DynamicTag>{headings.content}</DynamicTag>
            <ImagTag src={headings.imageAfterSRC} alt={headings.imageBeforeSRC} />
          </ImgContainer>
        </div>
      );
    } else {
